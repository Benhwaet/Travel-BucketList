...
marker43.bindPopup('Statue of Liberty, USA').openPopup();
marker44.bindPopup('Hollywood Sign, USA').openPopup();
marker45.bindPopup('Eiffel Tower, France').openPopup();
marker46.bindPopup('Banff National Park, Canada').openPopup();
marker47.bindPopup('Machu Picchu, Peru').openPopup();
marker48.bindPopup('Wellington, New Zealand').openPopup();
marker49.bindPopup('Ottawa, Canada').openPopup();
marker50.bindPopup('Quebec City, Canada').openPopup();
marker51.bindPopup('Vatican City').openPopup();
marker52.bindPopup('Germany').openPopup();
marker53.bindPopup('Australia').openPopup();
marker54.bindPopup('Canada').openPopup();
